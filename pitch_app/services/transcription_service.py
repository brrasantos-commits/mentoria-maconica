...
def transcribe_audio(client: OpenAI, audio_path: Path) -> str:
    transcription_prompt = (
        'Espere termos de estudo maçônico, ritualística, simbologia, rito, grau, '
        'catecismo, prancha, instrução, filosofia, ética, história da maçonaria, '
        'lapidação moral, esquadro, compasso, pedra bruta e desenvolvimento iniciático.'
    )
